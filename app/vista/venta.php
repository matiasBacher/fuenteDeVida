...
$arrayMedioPagos = $entityManager->getRepository(MedioPago::class)->findAll();
$precioMaximo = $entityManager->getRepository(Venta::class)
  ->findOneBy(criteria: ["errorVenta" => false], orderBy: ["total" => 'DESC'])->getTotalEnFecha();

$precioMinimo = $entityManager->getRepository(Venta::class)
