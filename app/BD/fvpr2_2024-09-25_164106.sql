...
CREATE TABLE `detalledeventas` (
  ...
  UNIQUE KEY `ID_DETALLe_2` (`ID_DETALLe`),
...
INSERT INTO `detalledeventas` VALUES (17,1,3,500,0),(18,2,4,600,1);
...
CREATE TABLE `ventas` (
  ...
  `METODODEPAGO_VENTA` int(11) NOT NULL DEFAULT 1,
...
INSERT INTO `ventas` VALUES (17,NULL,'2024-09-24','00:29:17',1,0,NULL,NULL,500),(18,NULL,'2024-09-24','00:29:17',1,0,NULL,NULL,300);
...
-- Dump completed on 2024-09-25 16:41:12
